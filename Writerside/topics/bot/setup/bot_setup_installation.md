...
<tldr>
    <p><b>Summary: Installing Ninja Bot</b></p>
    <br/>
    <ul>
        <li>Install <b>Ninja Bot</b> using the <b>Epic Launcher</b> and enable it in your project.</li>
...
<procedure title="Installing via the Epic Launcher" collapsible="true" default-state="expanded">
    <step>Open the <b>Epic Games Launcher</b> and locate the <b>Ninja Bot</b> code plugin.</step>
    <step>
    ...
    <step>Once installed, create or open your project, navigate to <b>Edit</b> &rarr; <b>Plugins</b> and find Ninja Bot on the list. You can search for it in the Search Bar too.</step>
...
<procedure title="GitHub Repository" collapsible="true" default-state="expanded">
    <step>Ensure that you have access to the Ninja Bot repository on <b>GitHub</b>.</step>
    ...
    <step><b>Clone</b> the Ninja Bot repository into your desired Plugins Folder.</step>
