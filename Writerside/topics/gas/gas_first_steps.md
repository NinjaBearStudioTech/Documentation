...
<procedure title="Create a G.A.S. Setup Data Asset" collapsible="true" default-state="expanded">
    ...
    <step>Add any <b>Attribute Sets</b> required by your project. For example, you can use the one provided by <a href="cbt_reference_attributes.md"><b>Ninja Combat</b></a>.</step>
