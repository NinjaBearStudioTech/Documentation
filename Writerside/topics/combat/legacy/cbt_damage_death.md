...
> **Opportunity Attacks**
>
> If you're using the [](cbt_concept_paired_animations.md) for executions or similar mechanics, prevent the Death Ability 
> from triggering while the `Combat.State.Opportunity.Victim` tag is active.  
{style="tip"}
