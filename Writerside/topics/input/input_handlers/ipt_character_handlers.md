...
For certain setups, such as _top-down with WASD movement_, a **[Forward Reference](ipt_forward_reference.md)** is required.
...
When using this version of the Handler, implement `ReplicatedMovementInterface` in the Pawn or Character, store or 
