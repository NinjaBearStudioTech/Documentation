...
the item's **quantity**, **durability**, depending on the [fragment configuration](inv_inventory_fragments.md).
...
Only items that include a [**Consumable Fragment**](inv_inventory_fragments.md) are eligible to be consumed by this ability.
