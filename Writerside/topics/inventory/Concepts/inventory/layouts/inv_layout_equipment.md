...
>
> This layout is designed to work alongside the [**Equipment Fragment**](inv_inventory_fragments.md) and requires an 
...
- An [**Equipment Fragment**](inv_inventory_fragments.md) on each item placed in this container.
...
## Linked Containers
This layout integrates with the [**Linked Container fragment**](inv_inventory_fragments.md), allowing you to define
