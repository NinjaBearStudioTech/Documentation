...
> **Item Dimensions**
>
> This layout is designed to work alongside the [**Dimensions Fragment**](inv_inventory_fragments.md), which defines an 
...
> **Item Dimensions**
> 
> Complex item shapes (such as L-forms) are defined by the [**Dimensions Fragment**](inv_inventory_fragments.md).
