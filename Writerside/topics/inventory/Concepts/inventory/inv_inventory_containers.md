...
- **Grid**: Represents a 2D coordinate (X, Y). Ideal for spatial inventories where [**item dimensions**](inv_inventory_fragments.md) are relevant to the presentation grid.
