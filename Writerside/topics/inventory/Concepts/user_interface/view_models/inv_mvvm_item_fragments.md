...
This ViewModel exposes data from the [**Dimensions Fragment**](inv_inventory_fragments.md), including the item's footprint and rotation state.
...
This ViewModel exposes data from the [**Durability Fragment**](inv_inventory_fragments.md), allowing you to monitor an 
...
This ViewModel exposes a specific [**Dynamic Attribute**](inv_inventory_fragments.md). It's usually created by
...
This ViewModel exposes all [**Dynamic Attributes**](inv_inventory_fragments.md) assigned to an item, allowing 
...
This ViewModel exposes data from the [**Economy Fragment**](inv_inventory_fragments.md), allowing your UI to represent 
...
container, configured by the [**Linked Container Fragment**](inv_inventory_fragments.md).
...
This ViewModel exposes data from the [**Level Fragment**](inv_inventory_fragments.md), allowing you to display and track an 
...
This ViewModel exposes data from the [**Nested Container Fragment**](inv_inventory_fragments.md), allowing you to 
...
This ViewModel exposes data from the [**Quality Fragment**](inv_inventory_fragments.md), allowing your UI to reflect the 
...
This ViewModel exposes data from the [**Stack Fragment**](inv_inventory_fragments.md), allowing the UI to represent item 
...
This ViewModel exposes data from the [**User Interface Fragment**](inv_inventory_fragments.md), allowing your 
...
This ViewModel exposes data from the [**Weight Fragment**](inv_inventory_fragments.md), allowing the UI to display item 
